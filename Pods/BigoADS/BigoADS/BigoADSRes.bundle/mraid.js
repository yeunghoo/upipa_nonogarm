...
(function() {
  ...
  bridge.notifyExposureChangeEvent = function(exposedPercentage, visibleRectangle, occlusionRectangles) {
  ...
  // getLocation is unavailable to forbid dsp to get user's privacy info
