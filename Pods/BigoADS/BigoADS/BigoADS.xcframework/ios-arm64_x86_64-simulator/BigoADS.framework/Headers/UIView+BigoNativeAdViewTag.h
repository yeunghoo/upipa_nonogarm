...
typedef NS_ENUM(int8_t, BigoNativeAdViewTag) {
    ...
    BigoNativeAdViewTagSKOAutoTrigger       = 31,
    BigoNativeAdViewTagMultiAdsOther        = 34, // 类别二的圆框内的Ad空白处，及类别一的综合endpage的空白区域
    BigoNativeAdViewTagMore                 = 35, // 类别二，More按钮
    BigoNativeAdViewTagCloseBtnFirstClick   = 36,
    BigoNativeAdViewTagAutoClickTracker     = 37
};
