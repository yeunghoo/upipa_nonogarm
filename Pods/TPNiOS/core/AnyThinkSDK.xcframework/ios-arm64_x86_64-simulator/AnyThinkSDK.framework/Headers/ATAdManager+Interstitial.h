...
typedef void(^NativeMixViewBlock)(ATNativeMixInterstitialView *selfRenderingMixInterstitialView);

typedef void(^ATInterstitialAdRemovalCompletionBlock)(BOOL success);
...
/// @param viewController - display ad window, If nil, the top view controller will be used.
/// @param delegate delegate object
/// @param nativeMixViewBlock mixad view
- (void)showInterstitialWithPlacementID:(NSString *)placementID
                                  scene:(NSString *)scene
                       inViewController:(nullable UIViewController *)viewController
                               delegate:(id<ATInterstitialDelegate>)delegate
