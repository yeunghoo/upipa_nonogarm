 ...
 */
@interface OMIDChartboostAdSessionContext : NSObject
...
- (nullable instancetype)initWithPartner:(OMIDChartboostPartner *)partner
                               ...
                               resources:(NSArray<OMIDChartboostVerificationScriptResource *> *)resources
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
...
- (nullable instancetype)initWithPartner:(OMIDChartboostPartner *)partner
                              ...
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                           universalAdID:(nullable OMIDChartboostUniversalAdID *)universalAdID
                                   error:(NSError *_Nullable *_Nullable)error;
