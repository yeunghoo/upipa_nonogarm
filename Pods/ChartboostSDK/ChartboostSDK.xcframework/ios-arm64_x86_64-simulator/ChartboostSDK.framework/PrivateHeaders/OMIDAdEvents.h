 ...
 */
@interface OMIDChartboostAdEvents : NSObject
 ...
 */
- (nullable instancetype)initWithAdSession:(nonnull OMIDChartboostAdSession *)session error:(NSError * _Nullable * _Nullable)error;
 ...
 */
- (BOOL)loadedWithVastProperties:(OMIDChartboostVASTProperties *_Nonnull)vastProperties
