 ...
 */
@interface OMIDChartboostAdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly) OMIDChartboostAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDChartboostAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDChartboostAdSessionContext *)context
